...
public:
  ...
  virtual int performWrite(void *ptr, llvm::GenericValue val, int typ) override { return -2; }
  virtual int performRead(void *ptr, int typ) override { return -2; }
  virtual void beginEvent(int tid) override {return;}
