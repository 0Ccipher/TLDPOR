 ...
 */
#include <config.h>
#ifndef __TLCC_SCEDULES_H__
#define __TLCC_SCEDULES_H__
#endif
...
struct CCSEvent{
 public:
    ...
    CCSEvent(IPid pid, Tid tid , int eindex)
...
struct CCSchedule{
  public:
    ...
    std::vector<std::vector<CCSEvent>> scheduled_rwevents;
...
class TLCCSchedules {
 public:
  ...
  //std::priority_queue<CCSEvent, std::vector<CCSEvent>, CCDepthCompare> scheduler;
