...
cl_memory_model(llvm::cl::NotHidden, llvm::cl::init(Configuration::MM_UNDEF),
                ...
                llvm::cl::values(clEnumValN(Configuration::SC,"sc","Sequential Consistency"),
                                 ...
                                 clEnumValN(Configuration::TLCCV,"tlccv","Causal Covergence"),
                                 clEnumValN(Configuration::TLCC,"tlcc","Causal Consistency"),
                                 clEnumValN(Configuration::TLCM,"tlcm","Causal Memory")
...
const std::set<std::string> &Configuration::commandline_opts(){
  static std::set<std::string> opts = {
    ...
    "sc","tso","pso","power","arm","tlccv","tlcc","tlcm",
    "smtlib",
...
void Configuration::check_commandline(){
  ...
  /* Check commandline switch compatibility with memory model. */
  {
    ...
    if(cl_memory_model == Configuration::TLCCV) mm = "TLCCV";
    if(cl_memory_model == Configuration::TLCC) mm = "TLCC";
    if(cl_memory_model == Configuration::TLCM) mm = "TLCM";//TODO
